...
# Load save computer vision models
# %%
"""import pandas as pd
...
plt.ylabel("model")
"""
### Make and evaluate random predictions with model 2 (best model)
# %%
...
try:
    ...
    print("Please install torchmetrics and mlxtend packages")
...
# %%
loaded_model_2 == model_2_results
# %%
